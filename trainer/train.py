...
train_dataloader = DataLoader(
    NNUEIterableDataset("data/nnue/dataset_v0/train", batch_size=16384, random_hflip=True),
    batch_size=None,
    num_workers=16,
...
for epoch in range(EPOCHS):
    ...
    model.weights_to_bin("searchengine/bin/nnue/AdamW_acc32_300M.bin")
    # print("Model saved to searchengine/bin/nnue/AdamW_acc32_300M.bin")
